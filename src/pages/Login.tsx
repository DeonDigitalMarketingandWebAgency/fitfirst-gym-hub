      ...
      <div className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center">
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 flex justify-center z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl">
            <div className="hidden md:flex flex-col justify-center items-center rounded-l-lg bg-gradient-to-br from-gym-blue/90 to-gym-blue/70 text-white p-12 shadow-2xl backdrop-blur-sm">
