...
const Footer = () => {
  return (
    <footer className="bg-gym-blue text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Fitness First</h3>
            <p className="text-sm text-gray-300 mb-4">
              Your journey to fitness excellence starts here. Join our community and transform your life.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-300 hover:text-gym-orange transition-colors">
                  Home
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/trainers" className="text-gray-300 hover:text-gym-orange transition-colors">
                  Trainers
                </Link>
              </li>
              <li>
                <Link to="/equipment" className="text-gray-300 hover:text-gym-orange transition-colors">
                  Equipment
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-gym-orange transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">123 Fitness Street, Gym City</p>
            <p className="text-gray-300 mb-2">+1 (123) 456-7890</p>
            <p className="text-gray-300 mb-2">info@fitnessfirst.com</p>
            <p className="text-gray-300 mb-4">Opening Hours: 6:00 AM - 10:00 PM</p>
          </div>
        </div>
